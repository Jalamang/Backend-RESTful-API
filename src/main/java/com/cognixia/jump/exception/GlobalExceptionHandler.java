...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> resourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
		...
		ErrorDetails errorDetails = new ErrorDetails(new Date(), // makes a timestamp at current system time
	...
	public ResponseEntity<?> globalException(OutOfStockException ex, WebRequest request) {
