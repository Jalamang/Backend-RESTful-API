...
@OpenAPIDefinition(
		...
		info = @Info(
					...
					description = "e-Commerce-Backend-RESTful-API: GET, CREATE, UPDATE, and DELETE",
...
public class ECommerceBackendResTfulApiApplication {

	public static void main(String[] args) {
		SpringApplication.run(ECommerceBackendResTfulApiApplication.class, args);
	}
